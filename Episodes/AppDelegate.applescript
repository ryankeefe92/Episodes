                            ...
                            try
                                ...
                                if errorNumber is equal to 6 then
                                    tell application "Finder"
                                        ...
                                        set name of the_file2 to name_1 & "_code6_error2.mkv"
                                    end tell
                                    else
                                    tell application "Finder"
                                        set name_1 to name of the_file
                                        ...
                                        set name of the_file2 to name_1 & "_notcode6_error2.mkv"
                                    end tell
                                end if
                            end try
                                ...
                                try
                                    ...
                                    if errorNumber is equal to 6 then
                                        ...
                                        tell application "Finder"
                                            ...
                                            set name of the_file2 to name_1 & "_notcode6_error3.mkv"
                                        end tell
                                    end if
                                end try
                                    ...
                                    try
                                        ...
                                        if errorNumber is equal to 6 then
                                            ...
                                            tell application "Finder"
                                                ...
                                                set name of the_file2 to name_1 & "_notcode6_error5.mkv"
                                            end tell
                                        end if
                                    end try
